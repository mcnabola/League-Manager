...
public class latestFinalLeague
{
	 ...
	 *input to method:passed a string of what the user wants to write to file and a filename of where the input is printed to.
	...
	public static void fixtureGeneration()throws IOException
	{
		...
		else
		{
			...
			{
				outputBoxs("Fixtures already exist for this league, it will now be regenerated");
	...
	/**
	 *check if a file exists and if it doesn't then it creates the file
	 *input:passed the filename in which it is checked.
	 *output:creates a file if it doesn't exist.
	 *
	 */	
	public static void checkIfExists(String fileName)throws IOException
	{
	 ...
	 /**
	   ...
	   *output-boolean dependent on if the file exists
	   *
	   **/
	 ...
	 *output-a boolean dependent on whether the input was valid
	 *
	 */	
	...
	//String b[][] = new String[teams.get(0).size()][14]; --both statements initialising b are equal
